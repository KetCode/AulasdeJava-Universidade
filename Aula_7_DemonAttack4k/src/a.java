...
public class a extends Applet implements Runnable {
  ...
  public void run() {
    ...
    while(true) {
      ...
      // draw background
      Color backgroundColor = playerExploding > 47
          ? explodingFlashColors[63 - playerExploding] : new Color(50,50,5);
        ...
        for(i = demons.size() - 1; i >= 0; i--) {
          ...
          if (demon[DEMON_EXPLODING] == 1) {
            ...
            g.drawImage(enemySprites[level][j + 3],
                ...
                0, 0, 8, 8, null);
            g.drawImage(enemySprites[level][j + 3],
                (int)demon[DEMON_X2], (int)demon[DEMON_Y],
                (int)demon[DEMON_X2] + 32, (int)demon[DEMON_Y] + 8,
                7, 0, 15, 8, null);
          } else {
      ...
      if (level < 84) {
        ...
        g.setColor(Color.WHITE);
        g.setFont(new Font("MonoType Corsiva", Font.ITALIC, 12));
        g.drawString("Demon Attack", 0, 205);
        g.setFont(new Font("Impact", 0, 10));
        g.drawString("Recorde:" + recorde, 90, 205);
  ...
  public void processKeyEvent(KeyEvent keyEvent) {
    ...
    if (k == VK_LIGA_TRAPACA) {cheat = true;}
    else if (k == VK_DESLIGA_TRAPACA) {cheat = false;}
  }
