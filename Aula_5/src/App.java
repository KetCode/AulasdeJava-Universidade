// Forma de criptografar uma frase com chave de deslocamento
...
public class App {
    ...
    public static void main(String[] args) {
        try {
            ...
            // Criptografando
            String textoCriptografado = criptografa(chave, texto);
            // Descriptografando
            String textoDescriptografado = decriptografa(chave, textoCriptografado);
    ...
    public static String decriptografa(int chave, String textoCifrado) {
